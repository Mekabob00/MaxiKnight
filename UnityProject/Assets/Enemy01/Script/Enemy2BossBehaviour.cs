...
public class Enemy2BossBehaviour : MonoBehaviour, IPlayerDamege
{
    #region SeliarizFild
    ...
    public void EnemyDestroy(string tag_Enemyname,string tag_Enemy4name)
    {
        ...
        GameObject[] Enemy4objects = GameObject.FindGameObjectsWithTag(tag_Enemy4name);
        foreach(GameObject Enemy4obj in Enemy4objects)
        {
            Destroy(Enemy4obj);
        }
    }
